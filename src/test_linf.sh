...
do 
python main.py --fd-eta 0.1 --max-queries 10000 --image-lr 0.005 --mode linf --online-lr 100 --exploration 0.01 --epsilon $epsilon --batch-size 500 --gradient-iters 1  --resume_path checkpoint/$resume_path | tee log/$epsilon/$resume_path.txt
done
done
